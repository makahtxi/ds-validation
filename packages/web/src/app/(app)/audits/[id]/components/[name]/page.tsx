...
export default function AuditComponentDetailPage() {
  ...
  const checkResults = Object.values(
    component.result as Record<string, unknown>,
  ) as CheckResult[];
          ...
          {CHECK_DEFS.map((def) => {
            ...
            if (!result) {
              return (
                <div
                  key={def.id}
                  className="rounded-lg border border-gray-100 p-4 opacity-50"
                >
              ...
              <div key={def.id} className="rounded-lg border border-gray-200 p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-lg font-bold text-gray-900">
                    {result.score}
                    <small className="text-gray-400">/100</small>
                  </span>
                </div>
                  ...
                  <details className="mt-3">
                    ...
                    <div className="mt-2 space-y-1">
                      {result.violations.slice(0, 20).map((v, i) => (
                        <div
                          key={i}
                          className="text-xs font-mono text-gray-500 py-1 border-b border-gray-50"
                        >
